package com.pavlovich.oitipu.lab1
...
class MainActivity : AppCompatActivity() {
    ...
    private val addOperationToInputExpression = View.OnClickListener {
        if (!isOperation)
        {
            viewModel.input.value += (it as AppCompatButton).text
            isOperation = true
    ...
    private fun initLandscapeOrientationListeners() {
        ...
        btn_add.setOnClickListener(addOperationToInputExpression)
        btn_subtract.setOnClickListener(addOperationToInputExpression)
        btn_multiply.setOnClickListener(addOperationToInputExpression)
        btn_divide.setOnClickListener(addOperationToInputExpression)
